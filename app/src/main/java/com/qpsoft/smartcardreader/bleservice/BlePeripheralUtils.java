package com.qpsoft.smartcardreader.bleservice;
...
import static com.qpsoft.smartcardreader.AppConfig.UUID_CHARREAD;
import static com.qpsoft.smartcardreader.AppConfig.UUID_DESCRIPTOR;
import static com.qpsoft.smartcardreader.AppConfig.UUID_NOTIFY;
import static com.qpsoft.smartcardreader.AppConfig.UUID_SERVER;
import static com.qpsoft.smartcardreader.AppConfig.UUID_WRITE;
...
//            super.onDescriptorReadRequest(device, requestId, offset, descriptor);
    ...
    public void startBluetoothLeAdvertiser(UUID parcelUUID) {
        ...
        AdvertiseData advertiseData = new AdvertiseData.Builder()
                ...
                //.addManufacturerData(0, "33333".getBytes())
                .build();
        //扫描回应的广播设置
